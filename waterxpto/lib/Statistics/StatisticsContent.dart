...
class StatisticsTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (avg > nationalAverage) {
      comparisonText = "${avg - nationalAverage} Above National Average ($nationalAverage L)";
    } else {
      comparisonText = "${nationalAverage - avg} Below National Average ($nationalAverage L)";
    }
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          ...
          Text(comparisonText, style: const TextStyle(fontSize: 21, fontWeight: FontWeight.w400),)
        ],
      ),
    );
  }
